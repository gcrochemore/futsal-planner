...
RSpec.describe NationalitiesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested nationality as @nationality" do
      nationality = Nationality.create! valid_attributes
      get :show, params: {id: nationality.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested nationality as @nationality" do
      nationality = Nationality.create! valid_attributes
      get :edit, params: {id: nationality.to_param}, session: valid_session
      expect(assigns(:nationality)).to eq(nationality)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Nationality" do
        expect {
          post :create, params: {nationality: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved nationality as @nationality" do
        post :create, params: {nationality: invalid_attributes}, session: valid_session
        expect(assigns(:nationality)).to be_a_new(Nationality)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested nationality" do
        nationality = Nationality.create! valid_attributes
        put :update, params: {id: nationality.to_param, nationality: new_attributes}, session: valid_session
        nationality.reload
      ...
      it "assigns the requested nationality as @nationality" do
        nationality = Nationality.create! valid_attributes
        put :update, params: {id: nationality.to_param, nationality: valid_attributes}, session: valid_session
        expect(assigns(:nationality)).to eq(nationality)
      end
    ...
    context "with invalid params" do
      it "assigns the nationality as @nationality" do
        nationality = Nationality.create! valid_attributes
        put :update, params: {id: nationality.to_param, nationality: invalid_attributes}, session: valid_session
        expect(assigns(:nationality)).to eq(nationality)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested nationality" do
      nationality = Nationality.create! valid_attributes
      expect {
        delete :destroy, params: {id: nationality.to_param}, session: valid_session
      }.to change(Nationality, :count).by(-1)
    end
